...
while True:
    ...
    for encoding in encodings:
        ...
        if True in matches:
            ...
            intruder_frame = vs.read()
            time.sleep(0.3)
            intruder_img = 'intruders/intruder_{}.png'.format(datetime.now())
            cv2.imwrite(intruder_img, intruder_frame)
            print('{} written!'.format(intruder_img))
            #img_count += 1
